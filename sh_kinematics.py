...
def shadow_hand_fk(theta):
    ...
    wrist1_T_wrist2 = tf_inv(WRIST2_T_WRIST1 @ zrot_matrix(theta[3]))
    w_T_wrist2 = w_T_wrist1 @ wrist1_T_wrist2
    # Thumb
    wrist1_T_th5 = WRIST1_T_TH5 @ zrot_matrix(theta[5])
    w_T_th5 = w_T_wrist1 @ wrist1_T_th5
    th5_T_th4 = TH5_T_TH4 @ zrot_matrix(theta[6])
    w_T_th4 = w_T_th5 @ th5_T_th4
    th4_T_th3 = TH4_T_TH3 @ zrot_matrix(theta[7])
    w_T_th3 = w_T_th4 @ th4_T_th3
    th3_T_th2 = TH3_T_TH2 @ zrot_matrix(theta[8])
    w_T_th2 = w_T_th3 @ th3_T_th2
    th2_T_th1 = TH2_T_TH1 @ zrot_matrix(theta[9])
    w_T_th1 = w_T_th2 @ th2_T_th1
    w_T_th0 = w_T_th1 @ TH1_T_TH0  # Unactuated
    # Index finger
    wrist1_T_ff4 = WRIST1_T_FF4 @ zrot_matrix(theta[10])
    w_T_ff4 = w_T_wrist1 @ wrist1_T_ff4
    ff4_T_ff3 = FF4_T_FF3 @ zrot_matrix(theta[11])
    w_T_ff3 = w_T_ff4 @ ff4_T_ff3
    ff3_T_ff2 = FF3_T_FF2 @ zrot_matrix(theta[12])
    w_T_ff2 = w_T_ff3 @ ff3_T_ff2
    ff2_T_ff1 = FF2_T_FF1 @ zrot_matrix(theta[12] * COUPLING_CONST)
    w_T_ff1 = w_T_ff2 @ ff2_T_ff1
    w_T_ff0 = w_T_ff1 @ FF1_T_FF0  # Unactuated
    # Middle finger
    wrist1_T_mf4 = WRIST1_T_MF4 @ zrot_matrix(theta[13])
    w_T_mf4 = w_T_wrist1 @ wrist1_T_mf4
    mf4_T_mf3 = MF4_T_MF3 @ zrot_matrix(theta[14])
    w_T_mf3 = w_T_mf4 @ mf4_T_mf3
    mf3_T_mf2 = MF3_T_MF2 @ zrot_matrix(theta[15])
    w_T_mf2 = w_T_mf3 @ mf3_T_mf2
    mf2_T_mf1 = MF2_T_MF1 @ zrot_matrix(theta[15] * COUPLING_CONST)
    w_T_mf1 = w_T_mf2 @ mf2_T_mf1
    w_T_mf0 = w_T_mf1 @ MF1_T_MF0  # Unactuated
    # Ring finger
    wrist1_T_rf4 = WRIST1_T_RF4 @ zrot_matrix(theta[16])
    w_T_rf4 = w_T_wrist1 @ wrist1_T_rf4
    rf4_T_rf3 = RF4_T_RF3 @ zrot_matrix(theta[17])
    w_T_rf3 = w_T_rf4 @ rf4_T_rf3
    rf3_T_rf2 = RF3_T_RF2 @ zrot_matrix(theta[18])
    w_T_rf2 = w_T_rf3 @ rf3_T_rf2
    rf2_T_rf1 = RF2_T_RF1 @ zrot_matrix(theta[18] * COUPLING_CONST)
    w_T_rf1 = w_T_rf2 @ rf2_T_rf1
    w_T_rf0 = w_T_rf1 @ RF1_T_RF0  # Unactuated
    # Little finger
    wrist1_T_lf5 = WRIST1_T_LF5 @ zrot_matrix(theta[19])
    w_T_lf5 = w_T_wrist1 @ wrist1_T_lf5
    lf5_T_lf4 = LF5_T_LF4 @ zrot_matrix(theta[20])
    w_T_lf4 = w_T_lf5 @ lf5_T_lf4
    lf4_T_lf3 = LF4_T_LF3 @ zrot_matrix(theta[21])
    w_T_lf3 = w_T_lf4 @ lf4_T_lf3
    lf3_T_lf2 = LF3_T_LF2 @ zrot_matrix(theta[22])
    w_T_lf2 = w_T_lf3 @ lf3_T_lf2
    lf2_T_lf1 = LF2_T_LF1 @ zrot_matrix(theta[22] * COUPLING_CONST)
    w_T_lf1 = w_T_lf2 @ lf2_T_lf1
